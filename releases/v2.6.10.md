...
- **Dependency Updates**: Refreshed resolved/transitive npm dependencies in `package-lock.json` and updated pinned Dockerfile transitive dependencies.
- **Security**: Updated Dockerfile transitive dependency `tar` to version `7.5.15`.
