...
- **Interactive Graph Visualization** - ReactFlow-powered dependency graph with color-coded nodes
  ...
  - 🟡 Yellow nodes for CASCADE operations
  - 🔵 Blue nodes for SET NULL operations
  - ⚪ Gray nodes for RESTRICT/NO ACTION
...
- **[Wiki](https://github.com/neverinfamous/d1-manager/wiki)** — Updated guides for new features
