...
### Dependencies
- **wrangler**: Downgraded 4.56.0 → 4.54.0 (4.56.0 deprecated due to AI module peer dependency bug and R2 Data Catalog issues)
...
- **[Database Management](https://github.com/neverinfamous/d1-manager/wiki/Database-Management)** — Export and import guides
- **[Bulk Operations](https://github.com/neverinfamous/d1-manager/wiki/Bulk-Operations)** — Batch export documentation
