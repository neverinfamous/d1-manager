...
export const TOKENIZER_PRESETS: TokenizerPreset[] = [
  {
    ...
    description: 'Unicode-aware tokenization with diacritic handling. Best for international text.',
    defaultParameters: {
      remove_diacritics: 1,
    },
  },
  {
    ...
    description: 'English word stemming (e.g., "running" → "run"). Best for English text search.',
    defaultParameters: {
      remove_diacritics: 1,
    },
  },
  {
    type: 'trigram',
    label: 'Trigram',
    description: 'Character n-gram tokenization. Best for fuzzy/substring matching and CJK languages.',
    defaultParameters: {
      case_sensitive: 0,
    },
  },
  {
    type: 'ascii',
    label: 'ASCII',
    description: 'Simple ASCII-only tokenization. Fastest but limited to ASCII characters.',
  },
];
