 ...
 */
function applyHierarchicalLayout(graphData: GraphData): {
  nodes: Node[];
  edges: Edge[];
} {
 ...
 */
function applyForceDirectedLayout(graphData: GraphData): {
  nodes: Node[];
  edges: Edge[];
} {
 ...
 */
function calculateForceDirectedPositions(
  graphData: GraphData,
 ...
 */
export function calculateFitView(nodes: Node[]): {
  zoom: number;
