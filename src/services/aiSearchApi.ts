...
function getCachedCompatibility(databaseId: string): AISearchCompatibility | null {
...
function setCachedCompatibility(databaseId: string, data: AISearchCompatibility): void {
 ...
 */
export async function getDashboardUrl(): Promise<{ url: string; accountId: string }> {
