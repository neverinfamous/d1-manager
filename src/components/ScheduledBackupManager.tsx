...
export function ScheduledBackupManager({
  ...
  const [editingSchedule, setEditingSchedule] =
    useState<ScheduledBackup | null>(null);
  ...
  const [formSchedule, setFormSchedule] =
    useState<ScheduledBackupSchedule>("daily");
  ...
  const hasExistingSchedule = schedules.some(
    (s) => s.database_id === formDatabaseId,
  );
      ...
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <p className="text-sm text-muted-foreground max-w-md mx-auto">
            Scheduled backups require R2 storage to be configured. Please add
            BACKUP_BUCKET and BACKUP_DO bindings to wrangler.toml and redeploy.
          </p>
        </div>
      </div>
    );
        ...
        <div className="flex gap-2">
          ...
          {(!isSingleDatabase || schedules.length === 0) && (
            <Button
              ...
              aria-label="Add scheduled backup"
            >
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <DatabaseIcon
                        className={`h-5 w-5 ${schedule.enabled === 1 ? "text-primary" : "text-muted-foreground"}`}
                      />
                      <div>
                        ...
                        <CardDescription className="flex items-center gap-1">
                          ...
                          {schedule.schedule_description ??
                            `${schedule.schedule} at ${schedule.hour}:00 UTC`}
                        </CardDescription>
                      </div>
                    </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 text-sm">
                    <div>
                      ...
                      <p
                        className={`font-medium ${overdue ? "text-amber-600 dark:text-amber-400" : ""}`}
                      >
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {formatScheduleDate(schedule.last_run_at)}
                      </p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {formatScheduleDate(schedule.created_at)}
                      </p>
                    </div>
                  </div>
        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-4 py-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm text-amber-800 dark:text-amber-200">
                    <p className="font-semibold mb-1">
                      ⚠️ Database contains {fts5Count} FTS5{" "}
                      {fts5Count === 1 ? "table" : "tables"}
                    </p>
                    <p className="text-xs text-amber-700 dark:text-amber-300">
                      Databases with FTS5 (Full-Text Search) tables may take
                      significantly longer to export and could timeout during
                      scheduled backups. The backup will be retried at the next
                      scheduled time if it fails. Consider using manual backups
                      for databases with large FTS5 indexes.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={formSchedule}
                onValueChange={(value: ScheduledBackupSchedule) =>
            ...
            {formSchedule === "weekly" && (
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormDayOfWeek(parseInt(value, 10))
                  }
                >
            ...
            {formSchedule === "monthly" && (
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormDayOfMonth(parseInt(value, 10))
                  }
                >
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete the scheduled backup for &quot;
              {deletingSchedule?.database_name}&quot;? This will not delete
              existing backups.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
